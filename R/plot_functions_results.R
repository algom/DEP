...
#' @param lab x-axis label. Default is "Baits"
...
plot_single <- function(dep, proteins, type = c("contrast", "centered"), plot = TRUE, lab="Baits") {
...
#### MOD
  ...
  ht1 = Heatmap(df,
    ...
    #name = legend,
    heatmap_legend_param = list(title = expression("log"[2]~legend)),
